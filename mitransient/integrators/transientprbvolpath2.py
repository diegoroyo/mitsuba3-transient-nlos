...
class TransientPRBVolpathIntegrator2(TransientADIntegrator):
    r"""
    .. _integrator-transientprbvolpath:
    ...
    def __init__(self, props=mi.Properties()):
        ...
        # TODO: might not be needed these three lines
    ...
    def sample(self,
        ...
        # TODO: in prbvolpath it returns the aovs
    ...
    def to_string(self):
        return f'PRBVolpathIntegrator2[max_depth = {self.max_depth}]'


mi.register_integrator("transient_prbvolpath_mod", lambda props: TransientPRBVolpathIntegrator2(props))